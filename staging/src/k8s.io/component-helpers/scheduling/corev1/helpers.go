...
import (
	...
	"k8s.io/component-helpers/scheduling/corev1/clusteraffinity"
...
// MatchClusterSelectorTerms checks whether the cluster labels and fields match cluster selector terms in ORed;
// nil or empty term matches no objects.
func MatchClusterSelectorTerms(
	...
	return clusteraffinity.NewLazyErrorClusterSelector(clusterSelector).Match(cluster)
}
