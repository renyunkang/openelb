...
var map_ClusterResourceQuotaSpec = map[string]string{
	...
	"ClusterSelector": "ClusterSelector is a selector which must be true for the workload to fit on a cluster. Selector which must match a cluster's labels for the workload to be scheduled on that cluster.",
}
...
var map_PersistentVolumeClaimSpec = map[string]string{
	...
	"volumeScope":      "VolumeScope determine pv created by either star cluster or planet cluster Default is Star",
}
...
var map_PersistentVolumeClaimStatus = map[string]string{
	...
	"clusterNames":       "ClusterNames represents the current clusters of PersistentVolumeClaim",
}
...
var map_PersistentVolumeSpec = map[string]string{
	...
	"clusterAffinity":               "ClusterAffinity defines constraints that limit what clusters this volume can be accessed from. This field influences the scheduling of pods that use this volume.",
	"volumeLocation":                "Volume will determine where the pv should be used Default is Remote",
}
...
var map_VolumeClusterAffinity = map[string]string{
	"":         "VolumeClusterAffinity defines constraints that limit what clusters this volume can be accessed from.",
	"Required": "Required specifies hard cluster constraints that must be met.",
}

func (VolumeClusterAffinity) SwaggerDoc() map[string]string {
	return map_VolumeClusterAffinity
}
