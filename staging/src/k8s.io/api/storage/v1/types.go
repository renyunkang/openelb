...
const (
	// ProvisionScopeLocal means the storageclass supports provision pv used by star cluster.
	ProvisionScopeLocal ProvisionScope = "Local"
	// ProvisionScopeRemote means the storageclass supports direct provision pv used by planet cluster.
	ProvisionScopeRemote ProvisionScope = "Remote"
)
...
type StorageClass struct {
	...
	// ProvisionScope indicates where volumes should be used.
	// Remote means volumes should be used in planet cluster.
	// Local means volumes should be used in star cluster.
	// Default is Remote
	// +optional
	ProvisionScope *ProvisionScope `json:"provisionScope,omitempty" protobuf:"bytes,9,opt,name=provisionScope,casttype=ProvisionScope"`
}
...
type CSIStorageCapacity struct {
	...
	// ClusterTopology defines which clusters have access to the storage
	// for which capacity was reported. If not set, the storage is
	// not accessible from any cluster in the cluster. If empty, the
	// storage is accessible from all clusters.  This field is
	// immutable.
	//
	// +optional
	ClusterTopology *metav1.LabelSelector `json:"clusterTopology,omitempty" protobuf:"bytes,6,opt,name=clusterTopology"`
}
