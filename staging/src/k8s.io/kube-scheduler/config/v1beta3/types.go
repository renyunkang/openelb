...
type KubeSchedulerProfile struct {
	...
	// StarNodeScheduleNamespaces is namespace list for star cluster to schedule pods
	// within star cluster.
	StarNodeScheduleNamespaces []string `json:"starNodeScheduleNamespaces,omitempty"`
}
...
type Plugins struct {
	...
	// ClusterPreScore is a list of plugins that are invoked before cluster scoring.
	ClusterPreScore PluginSet `json:"clusterPreScore,omitempty"`

	// ClusterScore is a list of plugins that should be invoked when ranking nodes that have passed the filtering phase.
	ClusterScore PluginSet `json:"clusterScore,omitempty"`

	// ClusterPreFilter is a list of plugins that should be invoked at "PreFilter" extension point of the scheduling framework.
	ClusterPreFilter PluginSet `json:"clusterPreFilter,omitempty"`

	// ClusterFilter is a list of plugins that should be invoked when filtering out nodes that cannot run the Pod.
	ClusterFilter PluginSet `json:"clusterFilter,omitempty"`
	...
	// ClusterReserve is a list of plugins invoked when reserving/unreserving resources
	// after a node is assigned to run the pod.
	ClusterReserve PluginSet `json:"clusterReserve,omitempty"`

	// ClusterPreBind is a list of plugins that should be invoked before a pod is bound.
	ClusterPreBind PluginSet `json:"clusterPreBind,omitempty"`

	// QueueSortForWorkload is a list of plugins that should be invoked when sorting pods in the scheduling queue.
	QueueSortForWorkload PluginSet `json:"queueSortForWorkload,omitempty"`

	// PreFilterForWorkload is a list of plugins that should be invoked at "PreFilter" extension point of the scheduling framework.
	PreFilterForWorkload PluginSet `json:"preFilterForWorkload,omitempty"`

	// FilterForWorkload is a list of plugins that should be invoked when filtering out nodes that cannot run the Pod.
	FilterForWorkload PluginSet `json:"filterForWorkload,omitempty"`

	// PostFilterForWorkload is a list of plugins that are invoked after filtering phase, no matter whether filtering succeeds or not.
	PostFilterForWorkload PluginSet `json:"postFilterForWorkload,omitempty"`

	// PreScoreForWorkload is a list of plugins that are invoked before scoring.
	PreScoreForWorkload PluginSet `json:"preScoreForWorkload,omitempty"`

	// ScoreForWorkload is a list of plugins that should be invoked when ranking nodes that have passed the filtering phase.
	ScoreForWorkload PluginSet `json:"scoreForWorkload,omitempty"`

	// Reserve is a list of plugins invoked when reserving/unreserving resources
	// after a node is assigned to run the pod.
	ReserveForWorkload PluginSet `json:"reserveForWorkload,omitempty"`

	// Permit is a list of plugins that control binding of a Pod. These plugins can prevent or delay binding of a Pod.
	PermitForWorkload PluginSet `json:"permitForWorkload,omitempty"`

	// PreBind is a list of plugins that should be invoked before a pod is bound.
	PreBindForWorkload PluginSet `json:"preBindForWorkload,omitempty"`

	// Bind is a list of plugins that should be invoked at "Bind" extension point of the scheduling framework.
	// The scheduler call these plugins in order. Scheduler skips the rest of these plugins as soon as one returns success.
	BindForWorkload PluginSet `json:"bindForWorkload,omitempty"`

	// PostBind is a list of plugins that should be invoked after a pod is successfully bound.
	PostBindForWorkload PluginSet `json:"postBindForWorkload,omitempty"`

	// QueueSortForStableModel is a list of plugins that should be invoked when sorting pods in the scheduling queue.
	QueueSortForStableModel PluginSet `json:"queueSortForStableModel,omitempty"`

	// PreFilterForStableModel is a list of plugins that should be invoked at "PreFilter" extension point of the scheduling framework.
	PreFilterForStableModel PluginSet `json:"preFilterForStableModel,omitempty"`

	// FilterForStableModel is a list of plugins that should be invoked when filtering out nodes that cannot run the Pod.
	FilterForStableModel PluginSet `json:"filterForStableModel,omitempty"`

	// PostFilterForStableModel is a list of plugins that are invoked after filtering phase, no matter whether filtering succeeds or not.
	PostFilterForStableModel PluginSet `json:"postFilterForStableModel,omitempty"`

	// PreScoreForStableModel is a list of plugins that are invoked before scoring.
	PreScoreForStableModel PluginSet `json:"preScoreForStableModel,omitempty"`

	// ScoreForStableModel is a list of plugins that should be invoked when ranking nodes that have passed the filtering phase.
	ScoreForStableModel PluginSet `json:"scoreForStableModel,omitempty"`

	// Reserve is a list of plugins invoked when reserving/unreserving resources
	// after a node is assigned to run the pod.
	ReserveForStableModel PluginSet `json:"reserveForStableModel,omitempty"`

	// Permit is a list of plugins that control binding of a Pod. These plugins can prevent or delay binding of a Pod.
	PermitForStableModel PluginSet `json:"permitForStableModel,omitempty"`

	// PreBind is a list of plugins that should be invoked before a pod is bound.
	PreBindForStableModel PluginSet `json:"preBindForStableModel,omitempty"`

	// Bind is a list of plugins that should be invoked at "Bind" extension point of the scheduling framework.
	// The scheduler call these plugins in order. Scheduler skips the rest of these plugins as soon as one returns success.
	BindForStableModel PluginSet `json:"bindForStableModel,omitempty"`

	// PostBind is a list of plugins that should be invoked after a pod is successfully bound.
	PostBindForStableModel PluginSet `json:"postBindForStableModel,omitempty"`
}
