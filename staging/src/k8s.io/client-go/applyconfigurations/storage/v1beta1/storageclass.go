...
type StorageClassApplyConfiguration struct {
	...
	*v1.ObjectMetaApplyConfiguration `json:"metadata,omitempty"`
	...
	ProvisionScope                   *v1beta1.ProvisionScope                                            `json:"provisionScope,omitempty"`
}
...
func (b *StorageClassApplyConfiguration) WithProvisionScope(value v1beta1.ProvisionScope) *StorageClassApplyConfiguration {
