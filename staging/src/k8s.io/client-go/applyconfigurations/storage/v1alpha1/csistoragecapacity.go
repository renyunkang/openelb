...
type CSIStorageCapacityApplyConfiguration struct {
	...
	*v1.ObjectMetaApplyConfiguration `json:"metadata,omitempty"`
	...
	ClusterTopology                  *v1.LabelSelectorApplyConfiguration `json:"clusterTopology,omitempty"`
}
...
// WithClusterTopology sets the ClusterTopology field in the declarative configuration to the given value
// and returns the receiver, so that objects can be built by chaining "With" function invocations.
// If called multiple times, the ClusterTopology field is set to the value of the last call.
func (b *CSIStorageCapacityApplyConfiguration) WithClusterTopology(value *v1.LabelSelectorApplyConfiguration) *CSIStorageCapacityApplyConfiguration {
	b.ClusterTopology = value
	return b
}
