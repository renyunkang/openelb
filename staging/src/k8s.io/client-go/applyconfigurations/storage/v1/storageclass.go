...
type StorageClassApplyConfiguration struct {
	...
	*v1.ObjectMetaApplyConfiguration `json:"metadata,omitempty"`
	...
	ProvisionScope                   *storagev1.ProvisionScope                                          `json:"provisionScope,omitempty"`
}
...
// WithProvisionScope sets the ProvisionScope field in the declarative configuration to the given value
// and returns the receiver, so that objects can be built by chaining "With" function invocations.
// If called multiple times, the ProvisionScope field is set to the value of the last call.
func (b *StorageClassApplyConfiguration) WithProvisionScope(value storagev1.ProvisionScope) *StorageClassApplyConfiguration {
	b.ProvisionScope = &value
	return b
}
