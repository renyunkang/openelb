...
func (b *IPStatusApplyConfiguration) WithName(value string) *IPStatusApplyConfiguration {
	b.Name = &value
	return b
}
...
func (b *IPStatusApplyConfiguration) WithStatus(value string) *IPStatusApplyConfiguration {
	b.Status = &value
	return b
}
...
func (b *IPStatusApplyConfiguration) WithIp(value string) *IPStatusApplyConfiguration {
	b.Ip = &value
	return b
}
...
func (b *IPStatusApplyConfiguration) WithBackend(value string) *IPStatusApplyConfiguration {
	b.Backend = &value
	return b
}
