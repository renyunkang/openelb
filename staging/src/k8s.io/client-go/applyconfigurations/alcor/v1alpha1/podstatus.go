...
type PodStatusApplyConfiguration struct {
	...
	Status *v1alpha1.Phase `json:"status,omitempty"`
}
...
func (b *PodStatusApplyConfiguration) WithName(value string) *PodStatusApplyConfiguration {
	b.Name = &value
	return b
}
...
func (b *PodStatusApplyConfiguration) WithStatus(value v1alpha1.Phase) *PodStatusApplyConfiguration {
	b.Status = &value
	return b
}
