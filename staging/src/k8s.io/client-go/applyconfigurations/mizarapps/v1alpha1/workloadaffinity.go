...
// WorkloadAffinityApplyConfiguration represents an declarative configuration of the WorkloadAffinity type for use
// with apply.
...
// WorkloadAffinityApplyConfiguration constructs an declarative configuration of the WorkloadAffinity type for use with
// apply.
...
func (b *WorkloadAffinityApplyConfiguration) WithRequiredDuringSchedulingIgnoredDuringExecution(values ...*WorkloadAffinityTermApplyConfiguration) *WorkloadAffinityApplyConfiguration {
	for i := range values {
		if values[i] == nil {
...
func (b *WorkloadAffinityApplyConfiguration) WithPreferredDuringSchedulingIgnoredDuringExecution(values ...*WeightedWorkloadAffinityTermApplyConfiguration) *WorkloadAffinityApplyConfiguration {
	for i := range values {
		if values[i] == nil {
