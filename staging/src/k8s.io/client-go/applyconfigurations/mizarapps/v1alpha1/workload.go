...
// Experimental!
func ExtractWorkload(workload *mizarappsv1alpha1.Workload, fieldManager string) (*WorkloadApplyConfiguration, error) {
...
// Experimental!
func ExtractWorkloadStatus(workload *mizarappsv1alpha1.Workload, fieldManager string) (*WorkloadApplyConfiguration, error) {
	return extractWorkload(workload, fieldManager, "status")
}

func extractWorkload(workload *mizarappsv1alpha1.Workload, fieldManager string, subresource string) (*WorkloadApplyConfiguration, error) {
	b := &WorkloadApplyConfiguration{}
	err := managedfields.ExtractInto(workload, internal.Parser().Type("io.k8s.api.mizarapps.v1alpha1.Workload"), fieldManager, b, subresource)
	if err != nil {
		return nil, err
	}
