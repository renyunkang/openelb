...
func (b *DaemonEndpointApplyConfiguration) WithProtocol(value string) *DaemonEndpointApplyConfiguration {
	b.Protocol = &value
	return b
}
...
func (b *DaemonEndpointApplyConfiguration) WithAddress(value string) *DaemonEndpointApplyConfiguration {
	b.Address = &value
	return b
}
