...
type ClusterSpecApplyConfiguration struct {
	...
	Addons *AddonsApplyConfiguration    `json:"addons,omitempty"`
}
...
func (b *ClusterSpecApplyConfiguration) WithAddons(value *AddonsApplyConfiguration) *ClusterSpecApplyConfiguration {
	b.Addons = value
	return b
}
