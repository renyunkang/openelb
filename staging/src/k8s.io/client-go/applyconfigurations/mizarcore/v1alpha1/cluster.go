...
// Experimental!
func ExtractCluster(cluster *mizarcorev1alpha1.Cluster, fieldManager string) (*ClusterApplyConfiguration, error) {
...
// Experimental!
func ExtractClusterStatus(cluster *mizarcorev1alpha1.Cluster, fieldManager string) (*ClusterApplyConfiguration, error) {
	return extractCluster(cluster, fieldManager, "status")
}

func extractCluster(cluster *mizarcorev1alpha1.Cluster, fieldManager string, subresource string) (*ClusterApplyConfiguration, error) {
	b := &ClusterApplyConfiguration{}
	err := managedfields.ExtractInto(cluster, internal.Parser().Type("io.k8s.api.mizarcore.v1alpha1.Cluster"), fieldManager, b, subresource)
	if err != nil {
		return nil, err
	}
