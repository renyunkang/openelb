...
func (b *ResourcesApplyConfiguration) WithCPU(value resource.Quantity) *ResourcesApplyConfiguration {
	b.CPU = &value
	return b
}
...
func (b *ResourcesApplyConfiguration) WithMemory(value resource.Quantity) *ResourcesApplyConfiguration {
	b.Memory = &value
	return b
}
...
func (b *ResourcesApplyConfiguration) WithPods(value int64) *ResourcesApplyConfiguration {
	b.Pods = &value
	return b
}
