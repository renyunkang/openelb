...
type PersistentVolumeClaimSpecApplyConfiguration struct {
	...
	VolumeScope      *v1.VolumeScope                              `json:"volumeScope,omitempty"`
...
// WithVolumeScope sets the VolumeScope field in the declarative configuration to the given value
// and returns the receiver, so that objects can be built by chaining "With" function invocations.
// If called multiple times, the VolumeScope field is set to the value of the last call.
func (b *PersistentVolumeClaimSpecApplyConfiguration) WithVolumeScope(value v1.VolumeScope) *PersistentVolumeClaimSpecApplyConfiguration {
	b.VolumeScope = &value
	return b
}
