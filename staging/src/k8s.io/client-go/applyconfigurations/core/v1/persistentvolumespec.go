...
type PersistentVolumeSpecApplyConfiguration struct {
	...
	ClusterAffinity                          *v1.VolumeClusterAffinity             `json:"clusterAffinity,omitempty"`
	VolumeLocation                           *v1.VolumeLocation                    `json:"volumeLocation,omitempty"`
}
...
func (b *PersistentVolumeSpecApplyConfiguration) WithClusterAffinity(value v1.VolumeClusterAffinity) *PersistentVolumeSpecApplyConfiguration {
	b.ClusterAffinity = &value
	return b
}

// WithVolumeLocation sets the VolumeLocation field in the declarative configuration to the given value
// and returns the receiver, so that objects can be built by chaining "With" function invocations.
// If called multiple times, the VolumeLocation field is set to the value of the last call.
func (b *PersistentVolumeSpecApplyConfiguration) WithVolumeLocation(value v1.VolumeLocation) *PersistentVolumeSpecApplyConfiguration {
	b.VolumeLocation = &value
	return b
}
