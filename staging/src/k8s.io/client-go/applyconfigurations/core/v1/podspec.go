...
type PodSpecApplyConfiguration struct {
	...
	ClusterTolerations            []ClusterTolerationApplyConfiguration        `json:"clusterTolerations,omitempty"`
...
func (b *PodSpecApplyConfiguration) WithClusterSelector(entries map[string]string) *PodSpecApplyConfiguration {
...
func (b *PodSpecApplyConfiguration) WithClusterTolerations(values ...*ClusterTolerationApplyConfiguration) *PodSpecApplyConfiguration {
	for i := range values {
		if values[i] == nil {
...
func (b *PodSpecApplyConfiguration) WithLocation(value *LocationApplyConfiguration) *PodSpecApplyConfiguration {
	b.Location = value
	return b
}
