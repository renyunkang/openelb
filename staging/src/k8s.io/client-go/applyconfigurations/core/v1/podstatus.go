...
type PodStatusApplyConfiguration struct {
	...
	NominateLocation           *LocationApplyConfiguration         `json:"nominateLocation,omitempty"`
}
...
// WithNominateLocation sets the NominateLocation field in the declarative configuration to the given value
// and returns the receiver, so that objects can be built by chaining "With" function invocations.
// If called multiple times, the NominateLocation field is set to the value of the last call.
func (b *PodStatusApplyConfiguration) WithNominateLocation(value *LocationApplyConfiguration) *PodStatusApplyConfiguration {
	b.NominateLocation = value
	return b
}
