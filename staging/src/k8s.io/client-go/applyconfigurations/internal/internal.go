...
- name: io.k8s.api.admissionregistration.v1beta1.WebhookClientConfig
  map:
    ...
    - name: url
      type:
        scalar: string
- name: io.k8s.api.alcor.v1alpha1.Affinity
  map:
    fields:
    - name: clusterAffinity
      type:
        namedType: io.k8s.api.alcor.v1alpha1.ClusterAffinity
    - name: stablemodelAffinity
      type:
        namedType: io.k8s.api.alcor.v1alpha1.StableModelAffinity
    - name: stablemodelAntiAffinity
      type:
        namedType: io.k8s.api.alcor.v1alpha1.StableModelAntiAffinity
- name: io.k8s.api.alcor.v1alpha1.ClusterAffinity
  map:
    fields:
    - name: preferredDuringSchedulingIgnoredDuringExecution
      type:
        list:
          elementType:
            namedType: io.k8s.api.alcor.v1alpha1.PreferredSchedulingTerm
          elementRelationship: atomic
    - name: requiredDuringSchedulingIgnoredDuringExecution
      type:
        namedType: io.k8s.api.alcor.v1alpha1.ClusterSelector
- name: io.k8s.api.alcor.v1alpha1.ClusterSelector
  map:
    fields:
    - name: clusterSelectorTerms
      type:
        list:
          elementType:
            namedType: io.k8s.api.alcor.v1alpha1.ClusterSelectorTerm
          elementRelationship: atomic
- name: io.k8s.api.alcor.v1alpha1.ClusterSelectorRequirement
  map:
    fields:
    - name: key
      type:
      ...
      type:
        list:
          elementType:
            scalar: string
          elementRelationship: atomic
- name: io.k8s.api.alcor.v1alpha1.ClusterSelectorTerm
  map:
    fields:
    - name: matchExpressions
      type:
        list:
          elementType:
            namedType: io.k8s.api.alcor.v1alpha1.ClusterSelectorRequirement
          elementRelationship: atomic
    - name: matchFields
      type:
        list:
          elementType:
            namedType: io.k8s.api.alcor.v1alpha1.ClusterSelectorRequirement
          elementRelationship: atomic
- name: io.k8s.api.alcor.v1alpha1.EventRecord
  map:
    fields:
    - name: createTime
      type:
    ...
    - name: lastMessage
      type:
        scalar: string
      default: ""
- name: io.k8s.api.alcor.v1alpha1.Features
  map:
    fields:
    - name: delayUpdatePod
      type:
    ...
    - name: preResizePod
      type:
        namedType: io.k8s.api.alcor.v1alpha1.ResizeResource
      default: {}
    - name: rebootPod
      type:
        scalar: boolean
    - name: rebootPodTimestamp
      type:
        scalar: string
    - name: resizePod
      type:
        namedType: io.k8s.api.alcor.v1alpha1.ResizeResource
      default: {}
- name: io.k8s.api.alcor.v1alpha1.IPPool
  map:
    fields:
    - name: apiVersion
      type:
    ...
    - name: spec
      type:
        namedType: io.k8s.api.alcor.v1alpha1.IPPoolSpec
      default: {}
    - name: status
      type:
        namedType: io.k8s.api.alcor.v1alpha1.IPPoolStatus
      default: {}
- name: io.k8s.api.alcor.v1alpha1.IPPoolSpec
  map:
    fields:
    - name: adminAssign
      type:
    ...
    - name: vlan
      type:
        scalar: numeric
- name: io.k8s.api.alcor.v1alpha1.IPPoolStatus
  map:
    fields:
    - name: Allocated
      type:
    ...
    - name: Status
      type:
        scalar: string
    - name: lastAppliedEndIP
      type:
        scalar: string
    - name: lastAppliedStartIP
      type:
        scalar: string
    - name: oldAllocatedIPs
      type:
        map:
          elementType:
            scalar: string
    - name: oldAvailableCount
      type:
        scalar: numeric
    - name: oldIPCount
      type:
    ...
    - name: oldStatus
      type:
        scalar: string
- name: io.k8s.api.alcor.v1alpha1.IPSet
  map:
    fields:
    - name: apiVersion
      type:
    ...
    - name: spec
      type:
        namedType: io.k8s.api.alcor.v1alpha1.IPSetSpec
      default: {}
    - name: status
      type:
        namedType: io.k8s.api.alcor.v1alpha1.IPSetStatus
      default: {}
- name: io.k8s.api.alcor.v1alpha1.IPSetSpec
  map:
    fields:
    - name: deprecated
      type:
    ...
    - name: vni
      type:
        scalar: boolean
- name: io.k8s.api.alcor.v1alpha1.IPSetStatus
  map:
    fields:
    - name: CallbackReason
      type:
    ...
    - name: Status
      type:
        scalar: string
      default: ""
- name: io.k8s.api.alcor.v1alpha1.IPStatus
  map:
    fields:
    - name: backend
      type:
    ...
    - name: status
      type:
        scalar: string
- name: io.k8s.api.alcor.v1alpha1.NetworkConfig
  map:
    fields:
    - name: host
      type:
    ...
    - name: vni
      type:
        scalar: boolean
- name: io.k8s.api.alcor.v1alpha1.NetworkRequest
  map:
    fields:
    - name: config
      type:
        namedType: io.k8s.api.alcor.v1alpha1.NetworkConfig
      default: {}
    - name: name
      type:
        scalar: string
    - name: networkClassName
      type:
        scalar: string
- name: io.k8s.api.alcor.v1alpha1.PVCStatus
  map:
    fields:
    - name: capacity
      type:
    ...
    - name: status
      type:
        scalar: string
      default: ""
- name: io.k8s.api.alcor.v1alpha1.PodStatus
  map:
    fields:
    - name: name
      type:
    ...
    - name: status
      type:
        scalar: string
- name: io.k8s.api.alcor.v1alpha1.PreferredSchedulingTerm
  map:
    fields:
    - name: preference
      type:
    ...
    - name: weight
      type:
        scalar: numeric
      default: 0
- name: io.k8s.api.alcor.v1alpha1.ResizeResource
  map:
    fields:
    - name: containersResource
      type:
        map:
          elementType:
            namedType: io.k8s.api.alcor.v1alpha1.ResourceLimit
    - name: podResource
      type:
        namedType: io.k8s.api.alcor.v1alpha1.ResourceLimit
      default: {}
- name: io.k8s.api.alcor.v1alpha1.ResourceLimit
  map:
    fields:
    - name: cpu
      type:
    ...
    - name: memory
      type:
        namedType: io.k8s.apimachinery.pkg.api.resource.Quantity
      default: {}
- name: io.k8s.api.alcor.v1alpha1.StableModel
  map:
    fields:
    - name: apiVersion
      type:
    ...
    - name: spec
      type:
        namedType: io.k8s.api.alcor.v1alpha1.StableModelSpec
      default: {}
    - name: status
      type:
        namedType: io.k8s.api.alcor.v1alpha1.StableModelStatus
      default: {}
- name: io.k8s.api.alcor.v1alpha1.StableModelAffinity
  map:
    fields:
    - name: preferredDuringSchedulingIgnoredDuringExecution
      type:
        list:
          elementType:
            namedType: io.k8s.api.alcor.v1alpha1.WeightedStableModelAffinityTerm
          elementRelationship: atomic
    - name: requiredDuringSchedulingIgnoredDuringExecution
      type:
        list:
          elementType:
            namedType: io.k8s.api.alcor.v1alpha1.StableModelAffinityTerm
          elementRelationship: atomic
- name: io.k8s.api.alcor.v1alpha1.StableModelAffinityTerm
  map:
    fields:
    - name: labelSelector
      type:
    ...
    - name: topologyKey
      type:
        scalar: string
      default: ""
- name: io.k8s.api.alcor.v1alpha1.StableModelAntiAffinity
  map:
    fields:
    - name: preferredDuringSchedulingIgnoredDuringExecution
      type:
      ...
      type:
        list:
          elementType:
            namedType: io.k8s.api.alcor.v1alpha1.StableModelAffinityTerm
          elementRelationship: atomic
- name: io.k8s.api.alcor.v1alpha1.StableModelCondition
  map:
    fields:
    ...
    - name: type
      type:
        scalar: string
      default: ""
- name: io.k8s.api.alcor.v1alpha1.StableModelSpec
  map:
    fields:
    - name: affinity
      type:
        namedType: io.k8s.api.alcor.v1alpha1.Affinity
    - name: clusterName
      type:
        scalar: string
    ...
    - name: feature
      type:
        namedType: io.k8s.api.alcor.v1alpha1.Features
      default: {}
    - name: mode
      type:
        scalar: string
    - name: network
      type:
        namedType: io.k8s.api.alcor.v1alpha1.NetworkRequest
      default: {}
    - name: nodeName
      type:
        scalar: string
    ...
    - name: storage
      type:
        list:
          elementType:
            namedType: io.k8s.api.alcor.v1alpha1.StorageRequest
          elementRelationship: atomic
    - name: tolerations
      type:
        list:
    ...
    - name: topologySpreadConstraints
      type:
        list:
          ...
          - topologyKey
          - whenUnsatisfiable
- name: io.k8s.api.alcor.v1alpha1.StableModelStatus
  map:
    fields:
    - name: conditions
      type:
        list:
          elementType:
            namedType: io.k8s.api.alcor.v1alpha1.StableModelCondition
          elementRelationship: associative
          keys:
          - type
    - name: driftPod
    ...
    - name: events
      type:
        list:
          elementType:
            namedType: io.k8s.api.alcor.v1alpha1.EventRecord
          elementRelationship: atomic
    - name: forceDriftPodTimestamp
      type:
        scalar: string
    - name: ipRef
      type:
        namedType: io.k8s.api.alcor.v1alpha1.IPStatus
      default: {}
    - name: nodeName
      type:
        scalar: string
    ...
    - name: podRef
      type:
        namedType: io.k8s.api.alcor.v1alpha1.PodStatus
      default: {}
    - name: pvcRefs
      type:
        list:
          elementType:
            namedType: io.k8s.api.alcor.v1alpha1.PVCStatus
          elementRelationship: atomic
    - name: rebootPodTimestamp
      type:
        scalar: string
    - name: resizePhase
      type:
        scalar: string
- name: io.k8s.api.alcor.v1alpha1.StorageRequest
  map:
    fields:
    - name: name
      type:
    ...
    - name: spec
      ...
      default: {}
- name: io.k8s.api.alcor.v1alpha1.WeightedStableModelAffinityTerm
  map:
    fields:
    - name: stablemodelAffinityTerm
      type:
        namedType: io.k8s.api.alcor.v1alpha1.StableModelAffinityTerm
      default: {}
    - name: weight
...
- name: io.k8s.api.core.v1.Affinity
  map:
    ...
    - name: clusterAffinity
      type:
        namedType: io.k8s.api.core.v1.ClusterAffinity
    - name: nodeAffinity
      type:
...
- name: io.k8s.api.core.v1.ClientIPConfig
  map:
    ...
    - name: timeoutSeconds
      type:
        scalar: numeric
- name: io.k8s.api.core.v1.ClusterAffinity
  map:
    fields:
    - name: preferredDuringSchedulingIgnoredDuringExecution
      type:
        list:
          elementType:
            namedType: io.k8s.api.core.v1.PreferredSchedulingClusterTerm
          elementRelationship: atomic
    - name: requiredDuringSchedulingIgnoredDuringExecution
      type:
        namedType: io.k8s.api.core.v1.ClusterSelector
- name: io.k8s.api.core.v1.ClusterResourceQuotaSpec
  map:
    fields:
    - name: ClusterSelector
      type:
      ...
      type:
        list:
          elementType:
            scalar: string
          elementRelationship: atomic
- name: io.k8s.api.core.v1.ClusterSelector
  map:
    fields:
    - name: clusterSelectorTerms
      type:
        list:
          elementType:
            namedType: io.k8s.api.core.v1.ClusterSelectorTerm
          elementRelationship: atomic
- name: io.k8s.api.core.v1.ClusterSelectorRequirement
  map:
    fields:
    - name: key
      type:
      ...
      type:
        list:
          elementType:
            scalar: string
          elementRelationship: atomic
- name: io.k8s.api.core.v1.ClusterSelectorTerm
  map:
    fields:
    - name: matchExpressions
      type:
        list:
          elementType:
            namedType: io.k8s.api.core.v1.ClusterSelectorRequirement
          elementRelationship: atomic
    - name: matchFields
      type:
        list:
          elementType:
            namedType: io.k8s.api.core.v1.ClusterSelectorRequirement
          elementRelationship: atomic
- name: io.k8s.api.core.v1.ClusterToleration
  map:
    fields:
    - name: effect
      type:
  ...
  map:
    ...
    - name: path
      type:
        scalar: string
      default: ""
- name: io.k8s.api.core.v1.Location
  map:
    fields:
    - name: clusterName
      type:
...
- name: io.k8s.api.core.v1.PersistentVolumeSpec
  map:
    ...
    - name: clusterAffinity
      type:
        namedType: io.k8s.api.core.v1.VolumeClusterAffinity
    - name: csi
      type:
  ...
  map:
    ...
    - name: clusterTolerations
      type:
        list:
          elementType:
            namedType: io.k8s.api.core.v1.ClusterToleration
          elementRelationship: atomic
    - name: containers
      type:
        list:
    ...
    - name: location
      type:
        namedType: io.k8s.api.core.v1.Location
    - name: nodeName
      type:
        scalar: string
    - name: nodeSelector
  ...
  map:
    ...
    - name: volumeID
      type:
        scalar: string
      default: ""
- name: io.k8s.api.core.v1.PreferredSchedulingClusterTerm
  map:
    fields:
    - name: preference
      type:
...
- name: io.k8s.api.core.v1.Volume
  map:
    ...
    - name: vsphereVolume
      type:
        namedType: io.k8s.api.core.v1.VsphereVirtualDiskVolumeSource
- name: io.k8s.api.core.v1.VolumeClusterAffinity
  map:
    fields:
    - name: Required
      type:
...
- name: io.k8s.api.imagepolicy.v1alpha1.ImageReviewStatus
  map:
    ...
    - name: reason
      type:
        scalar: string
- name: io.k8s.api.mizarapps.v1alpha1.Affinity
  map:
    fields:
    - name: clusterAffinity
      type:
        namedType: io.k8s.api.mizarapps.v1alpha1.ClusterAffinity
    - name: workloadAffinity
      type:
        namedType: io.k8s.api.mizarapps.v1alpha1.WorkloadAffinity
    - name: workloadAntiAffinity
      type:
        namedType: io.k8s.api.mizarapps.v1alpha1.WorkloadAntiAffinity
- name: io.k8s.api.mizarapps.v1alpha1.CRDResourceHook
  map:
    fields:
    - name: apiVersion
      type:
    ...
    - name: spec
      type:
        namedType: io.k8s.api.mizarapps.v1alpha1.CRDResourceHookSpec
      default: {}
    - name: status
      type:
        namedType: io.k8s.api.mizarapps.v1alpha1.CRDResourceHookStatus
      default: {}
- name: io.k8s.api.mizarapps.v1alpha1.CRDResourceHookSpec
  map:
    fields:
    - name: crdReference
      type:
        namedType: io.k8s.apimachinery.pkg.apis.meta.v1.GroupVersionKind
      default: {}
    - name: hook
      type:
        namedType: io.k8s.api.mizarapps.v1alpha1.ResourceCalculateHook
      default: {}
- name: io.k8s.api.mizarapps.v1alpha1.CRDResourceHookStatus
  map:
    fields:
    - name: active
      type:
        scalar: boolean
- name: io.k8s.api.mizarapps.v1alpha1.ClusterAffinity
  map:
    fields:
    - name: preferredDuringSchedulingIgnoredDuringExecution
      type:
        list:
          elementType:
            namedType: io.k8s.api.mizarapps.v1alpha1.PreferredSchedulingTerm
          elementRelationship: atomic
    - name: requiredDuringSchedulingIgnoredDuringExecution
      type:
        namedType: io.k8s.api.mizarapps.v1alpha1.ClusterSelector
- name: io.k8s.api.mizarapps.v1alpha1.ClusterQuota
  map:
    fields:
    - name: apiVersion
      type:
    ...
    - name: spec
      type:
        namedType: io.k8s.api.core.v1.ClusterResourceQuotaSpec
      default: {}
    - name: status
      type:
        namedType: io.k8s.api.core.v1.ResourceQuotaStatus
      default: {}
- name: io.k8s.api.mizarapps.v1alpha1.ClusterSelector
  map:
    fields:
    - name: clusterSelectorTerms
      type:
        list:
          elementType:
            namedType: io.k8s.api.mizarapps.v1alpha1.ClusterSelectorTerm
          elementRelationship: atomic
- name: io.k8s.api.mizarapps.v1alpha1.ClusterSelectorRequirement
  map:
    fields:
    - name: key
      type:
      ...
      type:
        list:
          elementType:
            scalar: string
          elementRelationship: atomic
- name: io.k8s.api.mizarapps.v1alpha1.ClusterSelectorTerm
  map:
    fields:
    - name: matchExpressions
      type:
        list:
          elementType:
            namedType: io.k8s.api.mizarapps.v1alpha1.ClusterSelectorRequirement
          elementRelationship: atomic
    - name: matchFields
      type:
        list:
          elementType:
            namedType: io.k8s.api.mizarapps.v1alpha1.ClusterSelectorRequirement
          elementRelationship: atomic
- name: io.k8s.api.mizarapps.v1alpha1.GlobalQuota
  map:
    fields:
    - name: apiVersion
      type:
    ...
    - name: status
      type:
        namedType: io.k8s.api.core.v1.ResourceQuotaStatus
      default: {}
- name: io.k8s.api.mizarapps.v1alpha1.K8SObject
  map:
    fields:
    - name: group
      type:
    ...
    - name: version
      type:
        scalar: string
      default: ""
- name: io.k8s.api.mizarapps.v1alpha1.K8SObjectStatus
  map:
    fields:
    - name: deleted
      type:
    ...
    - name: scheduled
      type:
        scalar: boolean
      default: false
- name: io.k8s.api.mizarapps.v1alpha1.Location
  map:
    fields:
    - name: nextCluster
      type:
        scalar: string
- name: io.k8s.api.mizarapps.v1alpha1.PreferredSchedulingTerm
  map:
    fields:
    - name: preference
      type:
    ...
    - name: weight
      type:
        scalar: numeric
      default: 0
- name: io.k8s.api.mizarapps.v1alpha1.ResourceCalculateHook
  map:
    fields:
    - name: caBase64
      type:
    ...
    - name: url
      type:
        scalar: string
- name: io.k8s.api.mizarapps.v1alpha1.WeightedWorkloadAffinityTerm
  map:
    fields:
    - name: weight
      type:
        scalar: numeric
      default: 0
    - name: workloadAffinityTerm
      type:
        namedType: io.k8s.api.mizarapps.v1alpha1.WorkloadAffinityTerm
      default: {}
- name: io.k8s.api.mizarapps.v1alpha1.Workload
  map:
    fields:
    - name: apiVersion
      type:
    ...
    - name: spec
      type:
        namedType: io.k8s.api.mizarapps.v1alpha1.WorkloadSpec
      default: {}
    - name: status
      type:
        namedType: io.k8s.api.mizarapps.v1alpha1.WorkloadStatus
      default: {}
- name: io.k8s.api.mizarapps.v1alpha1.WorkloadAffinity
  map:
    fields:
    - name: preferredDuringSchedulingIgnoredDuringExecution
      type:
        list:
          elementType:
            namedType: io.k8s.api.mizarapps.v1alpha1.WeightedWorkloadAffinityTerm
          elementRelationship: atomic
    - name: requiredDuringSchedulingIgnoredDuringExecution
      type:
        list:
          elementType:
            namedType: io.k8s.api.mizarapps.v1alpha1.WorkloadAffinityTerm
          elementRelationship: atomic
- name: io.k8s.api.mizarapps.v1alpha1.WorkloadAffinityTerm
  map:
    fields:
    - name: labelSelector
      type:
    ...
    - name: topologyKey
      type:
        scalar: string
      default: ""
- name: io.k8s.api.mizarapps.v1alpha1.WorkloadAntiAffinity
  map:
    fields:
    - name: preferredDuringSchedulingIgnoredDuringExecution
      type:
      ...
      type:
        list:
          elementType:
            namedType: io.k8s.api.mizarapps.v1alpha1.WorkloadAffinityTerm
          elementRelationship: atomic
- name: io.k8s.api.mizarapps.v1alpha1.WorkloadCondition
  map:
    fields:
    - name: lastTransitionTime
      type:
    ...
    - name: type
      type:
        scalar: string
      default: ""
- name: io.k8s.api.mizarapps.v1alpha1.WorkloadSpec
  map:
    fields:
    - name: checkFilters
      type:
        list:
          elementType:
            namedType: io.k8s.api.mizarapps.v1alpha1.K8SObject
          elementRelationship: atomic
    - name: destAffinity
      type:
        namedType: io.k8s.api.mizarapps.v1alpha1.Affinity
    - name: k8sObjects
      type:
        list:
          elementType:
    ...
    - name: location
      type:
        namedType: io.k8s.api.mizarapps.v1alpha1.Location
    - name: schedulerName
      type:
        scalar: string
    - name: type
      type:
        scalar: string
- name: io.k8s.api.mizarapps.v1alpha1.WorkloadStatus
  map:
    fields:
    - name: allocatedResources
      type:
    ...
    - name: conditions
      type:
        list:
          elementType:
            namedType: io.k8s.api.mizarapps.v1alpha1.WorkloadCondition
          elementRelationship: associative
          keys:
          - type
    - name: k8sObjectStatus
      type:
        list:
          elementType:
            namedType: io.k8s.api.mizarapps.v1alpha1.K8SObjectStatus
          elementRelationship: atomic
    - name: logicZone
      type:
        list:
    ...
    - name: region
      type:
        scalar: string
      default: ""
- name: io.k8s.api.mizarcore.v1alpha1.Addons
  map:
    fields:
    - name: initializeWorkloadCluster
      type:
        namedType: io.k8s.api.mizarcore.v1alpha1.InitializeWorkloadCluster
    - name: preRegisterWorkloadCluster
      type:
        namedType: io.k8s.api.mizarcore.v1alpha1.PreRegisterWorkloadCluster
- name: io.k8s.api.mizarcore.v1alpha1.Address
  map:
    fields:
    - name: address
      type:
    ...
    - name: type
      type:
        scalar: string
      default: ""
- name: io.k8s.api.mizarcore.v1alpha1.Auth
  map:
    fields:
    - name: kubeconfig
      type:
    ...
    - name: type
      type:
        scalar: string
      default: ""
- name: io.k8s.api.mizarcore.v1alpha1.Cluster
  map:
    fields:
    - name: apiVersion
      type:
    ...
    - name: spec
      type:
        namedType: io.k8s.api.mizarcore.v1alpha1.ClusterSpec
      default: {}
    - name: status
      type:
        namedType: io.k8s.api.mizarcore.v1alpha1.ClusterStatus
      default: {}
- name: io.k8s.api.mizarcore.v1alpha1.ClusterCondition
  map:
    fields:
    - name: lastHeartbeatTime
      type:
    ...
    - name: type
      type:
        scalar: string
      default: ""
- name: io.k8s.api.mizarcore.v1alpha1.ClusterDaemonEndpoints
  map:
    fields:
    - name: apiServerEndpoint
      type:
        namedType: io.k8s.api.mizarcore.v1alpha1.DaemonEndpoint
      default: {}
    - name: kubeletForClusterEndpoint
      type:
        namedType: io.k8s.api.mizarcore.v1alpha1.DaemonEndpoint
      default: {}
- name: io.k8s.api.mizarcore.v1alpha1.ClusterSecretRef
  map:
    fields:
    - name: name
      type:
    ...
    - name: namespace
      type:
        scalar: string
- name: io.k8s.api.mizarcore.v1alpha1.ClusterSet
  map:
    fields:
    - name: apiVersion
      type:
    ...
    - name: metadata
      type:
        namedType: io.k8s.apimachinery.pkg.apis.meta.v1.ObjectMeta
      default: {}
- name: io.k8s.api.mizarcore.v1alpha1.ClusterSpec
  map:
    fields:
    - name: addons
      type:
        namedType: io.k8s.api.mizarcore.v1alpha1.Addons
    - name: taints
      type:
        list:
          elementType:
            namedType: io.k8s.api.core.v1.Taint
          elementRelationship: atomic
- name: io.k8s.api.mizarcore.v1alpha1.ClusterStatus
  map:
    fields:
    - name: addresses
      type:
        list:
          elementType:
            namedType: io.k8s.api.mizarcore.v1alpha1.Address
          elementRelationship: atomic
    - name: allocatable
      type:
        map:
    ...
    - name: clusterInfo
      type:
        namedType: io.k8s.api.mizarcore.v1alpha1.Info
      default: {}
    - name: conditions
      type:
        list:
          elementType:
            namedType: io.k8s.api.mizarcore.v1alpha1.ClusterCondition
          elementRelationship: atomic
    - name: configuration
      type:
        namedType: io.k8s.api.mizarcore.v1alpha1.KubeletForClusterConfiguration
    - name: daemonEndpoints
      type:
        namedType: io.k8s.api.mizarcore.v1alpha1.ClusterDaemonEndpoints
      default: {}
    - name: namespaces
      type:
        list:
          elementType:
            namedType: io.k8s.api.mizarcore.v1alpha1.NamespaceUsage
          elementRelationship: atomic
    - name: nodes
      type:
        list:
          elementType:
            namedType: io.k8s.api.mizarcore.v1alpha1.NodeLeftResource
          elementRelationship: atomic
    - name: partitions
      type:
        list:
    ...
    - name: phase
      type:
        scalar: string
    - name: planetClusterAllocatable
      type:
        map:
          elementType:
            namedType: io.k8s.apimachinery.pkg.api.resource.Quantity
    - name: planetClusterNodes
      type:
        list:
          elementType:
            namedType: io.k8s.api.mizarcore.v1alpha1.NodeLeftResource
          elementRelationship: atomic
    - name: planetClusterUsage
      type:
        map:
          elementType:
            namedType: io.k8s.apimachinery.pkg.api.resource.Quantity
    - name: secretRef
      type:
        namedType: io.k8s.api.mizarcore.v1alpha1.ClusterSecretRef
      default: {}
    - name: storage
      type:
        list:
    ...
    - name: usage
      type:
        map:
          elementType:
            namedType: io.k8s.apimachinery.pkg.api.resource.Quantity
- name: io.k8s.api.mizarcore.v1alpha1.DaemonEndpoint
  map:
    fields:
    - name: address
      type:
    ...
    - name: protocol
      type:
        scalar: string
- name: io.k8s.api.mizarcore.v1alpha1.Info
  map:
    fields:
    - name: buildDate
      type:
    ...
    - name: platform
      type:
        scalar: string
      default: ""
- name: io.k8s.api.mizarcore.v1alpha1.InitConfiguration
  map:
    fields:
    ...
    - name: workerMachineCount
      type:
        scalar: numeric
- name: io.k8s.api.mizarcore.v1alpha1.InitializeWorkloadCluster
  map:
    fields:
    - name: configurations
      type:
        namedType: io.k8s.api.mizarcore.v1alpha1.InitConfiguration
    - name: name
      type:
        scalar: string
      default: ""
- name: io.k8s.api.mizarcore.v1alpha1.KubeletForClusterConfiguration
  map:
    fields:
    - name: auth
      type:
        namedType: io.k8s.api.mizarcore.v1alpha1.Auth
    - name: forceSyncFrequency
      type:
        scalar: numeric
    ...
    - name: target
      type:
        namedType: io.k8s.api.mizarcore.v1alpha1.Target
    - name: template
      type:
        scalar: string
    - name: topNodeN
      type:
        scalar: numeric
- name: io.k8s.api.mizarcore.v1alpha1.NamespaceUsage
  map:
    fields:
    - name: name
      type:
    ...
    - name: usage
      type:
        namedType: io.k8s.api.core.v1.ResourceRequirements
      default: {}
- name: io.k8s.api.mizarcore.v1alpha1.NodeLeftResource
  map:
    fields:
    - name: left
      type:
    ...
    - name: name
      type:
        scalar: string
      default: ""
- name: io.k8s.api.mizarcore.v1alpha1.PreRegisterWorkloadCluster
  map:
    fields:
    - name: configurations
      type:
    ...
    - name: name
      type:
        scalar: string
      default: ""
- name: io.k8s.api.mizarcore.v1alpha1.Target
  map:
    fields:
    - name: apiserver
      type:
        scalar: string
- name: io.k8s.api.mizarrbac.v1alpha1.AggregationRule
  map:
    fields:
    - name: globalRoleSelectors
      type:
        list:
          elementType:
            namedType: io.k8s.apimachinery.pkg.apis.meta.v1.LabelSelector
          elementRelationship: atomic
- name: io.k8s.api.mizarrbac.v1alpha1.GlobalRole
  map:
    fields:
    - name: aggregationRule
      type:
        namedType: io.k8s.api.mizarrbac.v1alpha1.AggregationRule
    - name: apiVersion
      type:
        scalar: string
    - name: clusterSelectors
      type:
        list:
          elementType:
            namedType: io.k8s.apimachinery.pkg.apis.meta.v1.LabelSelector
    ...
    - name: rules
      type:
        list:
          ...
          elementRelationship: atomic
- name: io.k8s.api.mizarrbac.v1alpha1.GlobalRoleBinding
  map:
    fields:
    - name: apiVersion
      type:
    ...
    elementType:
      ...
      map:
        elementType:
          namedType: __untyped_deduced_
        elementRelationship: separable
- name: io.k8s.apimachinery.pkg.apis.meta.v1.GroupVersionKind
  map:
    fields:
    - name: group
      type:
