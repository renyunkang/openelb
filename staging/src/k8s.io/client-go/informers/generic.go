...
func (f *sharedInformerFactory) ForResource(resource schema.GroupVersionResource) (GenericInformer, error) {
	...
	case v1alpha1.SchemeGroupVersion.WithResource("ippools"):
		return &genericInformer{resource: resource.GroupResource(), informer: f.Alcor().V1alpha1().IPPools().Informer()}, nil
	case v1alpha1.SchemeGroupVersion.WithResource("ipsets"):
		return &genericInformer{resource: resource.GroupResource(), informer: f.Alcor().V1alpha1().IPSets().Informer()}, nil
	case v1alpha1.SchemeGroupVersion.WithResource("stablemodels"):
		return &genericInformer{resource: resource.GroupResource(), informer: f.Alcor().V1alpha1().StableModels().Informer()}, nil
	...
	case mizarappsv1alpha1.SchemeGroupVersion.WithResource("crdresourcehooks"):
		return &genericInformer{resource: resource.GroupResource(), informer: f.Mizarapps().V1alpha1().CRDResourceHooks().Informer()}, nil
	case mizarappsv1alpha1.SchemeGroupVersion.WithResource("clusterquotas"):
		return &genericInformer{resource: resource.GroupResource(), informer: f.Mizarapps().V1alpha1().ClusterQuotas().Informer()}, nil
	case mizarappsv1alpha1.SchemeGroupVersion.WithResource("globalquotas"):
		return &genericInformer{resource: resource.GroupResource(), informer: f.Mizarapps().V1alpha1().GlobalQuotas().Informer()}, nil
	case mizarappsv1alpha1.SchemeGroupVersion.WithResource("workloads"):
		return &genericInformer{resource: resource.GroupResource(), informer: f.Mizarapps().V1alpha1().Workloads().Informer()}, nil
	...
	case mizarcorev1alpha1.SchemeGroupVersion.WithResource("clusters"):
		return &genericInformer{resource: resource.GroupResource(), informer: f.Mizarcore().V1alpha1().Clusters().Informer()}, nil
	case mizarcorev1alpha1.SchemeGroupVersion.WithResource("clustersets"):
		return &genericInformer{resource: resource.GroupResource(), informer: f.Mizarcore().V1alpha1().ClusterSets().Informer()}, nil
	...
	case mizarrbacv1alpha1.SchemeGroupVersion.WithResource("globalroles"):
		return &genericInformer{resource: resource.GroupResource(), informer: f.Mizarrbac().V1alpha1().GlobalRoles().Informer()}, nil
	case mizarrbacv1alpha1.SchemeGroupVersion.WithResource("globalrolebindings"):
		return &genericInformer{resource: resource.GroupResource(), informer: f.Mizarrbac().V1alpha1().GlobalRoleBindings().Informer()}, nil
