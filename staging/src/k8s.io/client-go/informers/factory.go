...
import (
	...
	alcor "k8s.io/client-go/informers/alcor"
	...
	mizarapps "k8s.io/client-go/informers/mizarapps"
	mizarcore "k8s.io/client-go/informers/mizarcore"
	mizarrbac "k8s.io/client-go/informers/mizarrbac"
...
type SharedInformerFactory interface {
	...
	Mizarapps() mizarapps.Interface
	Mizarcore() mizarcore.Interface
	Mizarrbac() mizarrbac.Interface
...
func (f *sharedInformerFactory) Alcor() alcor.Interface {
	return alcor.New(f, f.namespace, f.tweakListOptions)
}
...
func (f *sharedInformerFactory) Mizarapps() mizarapps.Interface {
	return mizarapps.New(f, f.namespace, f.tweakListOptions)
}

func (f *sharedInformerFactory) Mizarcore() mizarcore.Interface {
	return mizarcore.New(f, f.namespace, f.tweakListOptions)
}

func (f *sharedInformerFactory) Mizarrbac() mizarrbac.Interface {
	return mizarrbac.New(f, f.namespace, f.tweakListOptions)
}
