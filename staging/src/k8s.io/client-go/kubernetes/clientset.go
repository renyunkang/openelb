...
import (
	...
	alcorv1alpha1 "k8s.io/client-go/kubernetes/typed/alcor/v1alpha1"
	...
	mizarappsv1alpha1 "k8s.io/client-go/kubernetes/typed/mizarapps/v1alpha1"
	mizarcorev1alpha1 "k8s.io/client-go/kubernetes/typed/mizarcore/v1alpha1"
	mizarrbacv1alpha1 "k8s.io/client-go/kubernetes/typed/mizarrbac/v1alpha1"
...
type Interface interface {
	...
	AlcorV1alpha1() alcorv1alpha1.AlcorV1alpha1Interface
	...
	MizarappsV1alpha1() mizarappsv1alpha1.MizarappsV1alpha1Interface
	MizarcoreV1alpha1() mizarcorev1alpha1.MizarcoreV1alpha1Interface
	MizarrbacV1alpha1() mizarrbacv1alpha1.MizarrbacV1alpha1Interface
...
type Clientset struct {
	*discovery.DiscoveryClient
	...
	alcorV1alpha1                *alcorv1alpha1.AlcorV1alpha1Client
	...
	mizarappsV1alpha1            *mizarappsv1alpha1.MizarappsV1alpha1Client
	mizarcoreV1alpha1            *mizarcorev1alpha1.MizarcoreV1alpha1Client
	mizarrbacV1alpha1            *mizarrbacv1alpha1.MizarrbacV1alpha1Client
...
// AlcorV1alpha1 retrieves the AlcorV1alpha1Client
func (c *Clientset) AlcorV1alpha1() alcorv1alpha1.AlcorV1alpha1Interface {
	return c.alcorV1alpha1
}
...
// MizarappsV1alpha1 retrieves the MizarappsV1alpha1Client
func (c *Clientset) MizarappsV1alpha1() mizarappsv1alpha1.MizarappsV1alpha1Interface {
	return c.mizarappsV1alpha1
}

// MizarcoreV1alpha1 retrieves the MizarcoreV1alpha1Client
func (c *Clientset) MizarcoreV1alpha1() mizarcorev1alpha1.MizarcoreV1alpha1Interface {
	return c.mizarcoreV1alpha1
}

// MizarrbacV1alpha1 retrieves the MizarrbacV1alpha1Client
func (c *Clientset) MizarrbacV1alpha1() mizarrbacv1alpha1.MizarrbacV1alpha1Interface {
	return c.mizarrbacV1alpha1
}
...
func NewForConfigAndClient(c *rest.Config, httpClient *http.Client) (*Clientset, error) {
	...
	cs.alcorV1alpha1, err = alcorv1alpha1.NewForConfigAndClient(&configShallowCopy, httpClient)
	if err != nil {
		return nil, err
	}
	...
	cs.mizarappsV1alpha1, err = mizarappsv1alpha1.NewForConfigAndClient(&configShallowCopy, httpClient)
	if err != nil {
		return nil, err
	}
	cs.mizarcoreV1alpha1, err = mizarcorev1alpha1.NewForConfigAndClient(&configShallowCopy, httpClient)
	if err != nil {
		return nil, err
	}
	cs.mizarrbacV1alpha1, err = mizarrbacv1alpha1.NewForConfigAndClient(&configShallowCopy, httpClient)
	if err != nil {
		return nil, err
	}
...
func New(c rest.Interface) *Clientset {
	...
	cs.alcorV1alpha1 = alcorv1alpha1.New(c)
	...
	cs.mizarappsV1alpha1 = mizarappsv1alpha1.New(c)
	cs.mizarcoreV1alpha1 = mizarcorev1alpha1.New(c)
	cs.mizarrbacV1alpha1 = mizarrbacv1alpha1.New(c)
