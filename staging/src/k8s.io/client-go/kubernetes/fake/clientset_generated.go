...
import (
	...
	fakealcorv1alpha1 "k8s.io/client-go/kubernetes/typed/alcor/v1alpha1/fake"
	...
	fakemizarappsv1alpha1 "k8s.io/client-go/kubernetes/typed/mizarapps/v1alpha1/fake"
	mizarcorev1alpha1 "k8s.io/client-go/kubernetes/typed/mizarcore/v1alpha1"
	fakemizarcorev1alpha1 "k8s.io/client-go/kubernetes/typed/mizarcore/v1alpha1/fake"
	mizarrbacv1alpha1 "k8s.io/client-go/kubernetes/typed/mizarrbac/v1alpha1"
	fakemizarrbacv1alpha1 "k8s.io/client-go/kubernetes/typed/mizarrbac/v1alpha1/fake"
...
func (c *Clientset) AlcorV1alpha1() alcorv1alpha1.AlcorV1alpha1Interface {
	return &fakealcorv1alpha1.FakeAlcorV1alpha1{Fake: &c.Fake}
}
...
func (c *Clientset) MizarappsV1alpha1() mizarappsv1alpha1.MizarappsV1alpha1Interface {
	return &fakemizarappsv1alpha1.FakeMizarappsV1alpha1{Fake: &c.Fake}
}
...
func (c *Clientset) MizarcoreV1alpha1() mizarcorev1alpha1.MizarcoreV1alpha1Interface {
	return &fakemizarcorev1alpha1.FakeMizarcoreV1alpha1{Fake: &c.Fake}
}
...
func (c *Clientset) MizarrbacV1alpha1() mizarrbacv1alpha1.MizarrbacV1alpha1Interface {
	return &fakemizarrbacv1alpha1.FakeMizarrbacV1alpha1{Fake: &c.Fake}
}
