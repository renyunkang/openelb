...
var ippoolsResource = schema.GroupVersionResource{Group: "alcor.io", Version: "v1alpha1", Resource: "ippools"}

var ippoolsKind = schema.GroupVersionKind{Group: "alcor.io", Version: "v1alpha1", Kind: "IPPool"}
...
func (c *FakeIPPools) Apply(ctx context.Context, iPPool *alcorv1alpha1.IPPoolApplyConfiguration, opts v1.ApplyOptions) (result *v1alpha1.IPPool, err error) {
	if iPPool == nil {
	...
	obj, err := c.Fake.
		Invokes(testing.NewRootPatchSubresourceAction(ippoolsResource, *name, types.ApplyPatchType, data), &v1alpha1.IPPool{})
	if obj == nil {
		return nil, err
	}
	return obj.(*v1alpha1.IPPool), err
...
func (c *FakeIPPools) ApplyStatus(ctx context.Context, iPPool *alcorv1alpha1.IPPoolApplyConfiguration, opts v1.ApplyOptions) (result *v1alpha1.IPPool, err error) {
	if iPPool == nil {
		return nil, fmt.Errorf("iPPool provided to Apply must not be nil")
	}
	data, err := json.Marshal(iPPool)
	...
	obj, err := c.Fake.
		Invokes(testing.NewRootPatchSubresourceAction(ippoolsResource, *name, types.ApplyPatchType, data, "status"), &v1alpha1.IPPool{})
	if obj == nil {
		return nil, err
	}
	return obj.(*v1alpha1.IPPool), err
