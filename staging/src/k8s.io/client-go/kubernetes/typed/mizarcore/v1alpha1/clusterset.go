...
type ClusterSetInterface interface {
	...
	Apply(ctx context.Context, clusterSet *mizarcorev1alpha1.ClusterSetApplyConfiguration, opts v1.ApplyOptions) (result *v1alpha1.ClusterSet, err error)
	ClusterSetExpansion
}
...
func newClusterSets(c *MizarcoreV1alpha1Client) *clusterSets {
	return &clusterSets{
		client: c.RESTClient(),
	}
}
...
func (c *clusterSets) Apply(ctx context.Context, clusterSet *mizarcorev1alpha1.ClusterSetApplyConfiguration, opts v1.ApplyOptions) (result *v1alpha1.ClusterSet, err error) {
	if clusterSet == nil {
