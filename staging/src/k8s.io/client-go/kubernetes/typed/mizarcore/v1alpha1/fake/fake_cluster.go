...
var clustersResource = schema.GroupVersionResource{Group: "core.mizargalaxy.mizar-k8s.io", Version: "v1alpha1", Resource: "clusters"}

var clustersKind = schema.GroupVersionKind{Group: "core.mizargalaxy.mizar-k8s.io", Version: "v1alpha1", Kind: "Cluster"}
...
func (c *FakeClusters) Apply(ctx context.Context, cluster *mizarcorev1alpha1.ClusterApplyConfiguration, opts v1.ApplyOptions) (result *v1alpha1.Cluster, err error) {
	if cluster == nil {
...
func (c *FakeClusters) ApplyStatus(ctx context.Context, cluster *mizarcorev1alpha1.ClusterApplyConfiguration, opts v1.ApplyOptions) (result *v1alpha1.Cluster, err error) {
	if cluster == nil {
		return nil, fmt.Errorf("cluster provided to Apply must not be nil")
	}
	data, err := json.Marshal(cluster)
