...
import (
	...
	mizarcorev1alpha1 "k8s.io/client-go/applyconfigurations/mizarcore/v1alpha1"
	testing "k8s.io/client-go/testing"
)

// FakeClusterSets implements ClusterSetInterface
type FakeClusterSets struct {
	Fake *FakeMizarcoreV1alpha1
}

var clustersetsResource = schema.GroupVersionResource{Group: "core.mizargalaxy.mizar-k8s.io", Version: "v1alpha1", Resource: "clustersets"}

var clustersetsKind = schema.GroupVersionKind{Group: "core.mizargalaxy.mizar-k8s.io", Version: "v1alpha1", Kind: "ClusterSet"}
...
func (c *FakeClusterSets) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
	_, err := c.Fake.
		Invokes(testing.NewRootDeleteActionWithOptions(clustersetsResource, name, opts), &v1alpha1.ClusterSet{})
	return err
}
...
// Apply takes the given apply declarative configuration, applies it and returns the applied clusterSet.
func (c *FakeClusterSets) Apply(ctx context.Context, clusterSet *mizarcorev1alpha1.ClusterSetApplyConfiguration, opts v1.ApplyOptions) (result *v1alpha1.ClusterSet, err error) {
	if clusterSet == nil {
		return nil, fmt.Errorf("clusterSet provided to Apply must not be nil")
	}
	data, err := json.Marshal(clusterSet)
	if err != nil {
		return nil, err
	}
	name := clusterSet.Name
	if name == nil {
		return nil, fmt.Errorf("clusterSet.Name must be provided to Apply")
	}
	obj, err := c.Fake.
		Invokes(testing.NewRootPatchSubresourceAction(clustersetsResource, *name, types.ApplyPatchType, data), &v1alpha1.ClusterSet{})
	if obj == nil {
		return nil, err
	}
	return obj.(*v1alpha1.ClusterSet), err
